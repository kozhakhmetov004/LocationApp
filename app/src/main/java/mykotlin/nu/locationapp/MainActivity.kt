...
import mykotlin.nu.locationapp.ui.theme.LocationAppTheme
...
fun LocationDisplay(locationUtils: LocationUtils,viewModel: LocationViewModel, context: Context){
        ...
        onResult = {
            ...
            if(permissions[Manifest.permission.ACCESS_COARSE_LOCATION]==true
                ...
                val rationaleRequired= ActivityCompat.shouldShowRequestPermissionRationale(context as MainActivity,
                    Manifest.permission.ACCESS_COARSE_LOCATION)||ActivityCompat.shouldShowRequestPermissionRationale(context as MainActivity,
    ...
    Column(modifier = Modifier.fillMaxSize(),
        ...
        if(location!=null){
            Text(text = "Current address: ${address}")
        }else {
